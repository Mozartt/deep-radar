...
for i = 1:numSamples
    ...
    %% ---------------------------------
    [targets, K] = sample_targets_by_quadrants(0, radius, zRange(1), zRange(2), numOfTargets);
    ...
    [y_clean, y_ell, tau, phi] = get_radar_response_noisy(targets, alpha, SNR, size(targets,1), K, true);
